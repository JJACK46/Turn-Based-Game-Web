...
function SettingPopup({ variable, setVariable }: Props) {
            ...
            {variable && (
                <div className='absolute inset-0 flex items-center justify-center'>
                    ...
                    <div className='absolute w-4/5 h-3/5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-700 flex flex-col items-center p-10 gap-2 z-10'>
                        <h1 className='font-mono font-extrabold text-5xl'>Setting</h1>

                        <h1 className='font-mono font-bold text-2xl'>SETTING 1</h1>
                        ...
                        <h1 className='font-mono font-bold text-2xl'>SETTING 2</h1>
                        <div className='flex justify-center gap-5'>
                            <button onClick={() => setTest((test - 1 >= 0) ? test - 1 : test)} className='font-mono text-lg border-white border-2 px-4'>-</button>
                            <h1>{test}</h1>
                            <button onClick={() => setTest((test + 1 <= 10) ? test + 1 : test)} className='font-mono text-lg border-white border-2 px-4'>+</button>
                        </div>
                        <h1 className='font-mono font-bold text-2xl'>SETTING 3</h1>
                        <div className='flex justify-center gap-5'>
                            <button onClick={() => setTest((test - 1 >= 0) ? test - 1 : test)} className='font-mono text-lg border-white border-2 px-4'>-</button>
                            <h1>{test}</h1>
                            <button onClick={() => setTest((test + 1 <= 10) ? test + 1 : test)} className='font-mono text-lg border-white border-2 px-4'>+</button>
                        </div>
                        <h1 className='font-mono font-bold text-2xl'>SETTING 4</h1>
                        <div className='flex justify-center gap-5'>
                            <button onClick={() => setTest((test - 1 >= 0) ? test - 1 : test)} className='font-mono text-lg border-white border-2 px-4'>-</button>
                            <h1>{test}</h1>
                            <button onClick={() => setTest((test + 1 <= 10) ? test + 1 : test)} className='font-mono text-lg border-white border-2 px-4'>+</button>
