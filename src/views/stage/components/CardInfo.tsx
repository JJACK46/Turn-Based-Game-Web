                ...
                <div className="flex flex-col gap-4 items-center">
                    <div className="flex flex-row rounded-lg">
                        ...
                        <div className="flex flex-col p-5 text-center gap-4">
                            <h1 className="font-mono text-3xl font-bold">{currentEntityData?.entity.name}</h1>
                            <div className="flex justify-around flex-wrap">
                                <p className="font-mono text-lg w-1/2">Level</p>
                                <p className="font-mono text-lg w-1/2">{currentEntityData?.entity.level}</p>
                                <p className="font-mono text-lg w-1/2">Attack</p>
                                <p className="font-mono text-lg w-1/2">{currentEntityData?.entity.attackPower}</p>
                                <p className="font-mono text-lg w-1/2">Defence</p>
                                <p className="font-mono text-lg w-1/2">{currentEntityData?.entity.defendPower}</p>
                                <p className="font-mono text-lg w-1/2">Speed</p>
                                <p className="font-mono text-lg w-1/2">{currentEntityData?.entity.speed}</p>
                            </div>
                        </div>
                    </div>
