...
export default function Card(props: Props) {
    ...
    return (
        <>
            <button key={index} onClick={() => setSelectedEntity(selectedEntity)} className='h-32 w-20'>
                <div
          ...
          "
                >
                    <img
                        ...
                        width={200}
                    />
                    <p className="capitalize text-center text-sm">{selectedEntity.trait}</p>
                    <p className="capitalize text-center text-xs">{selectedEntity.level}</p>
                </div>
            </button>
        </>
    )
