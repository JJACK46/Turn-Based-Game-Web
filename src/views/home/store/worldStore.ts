...
type World = {
    ...
    setMap: (ID: string, BG: string, items: (Weapon | Armor)[], commonEntity: Entity[], hardEntity: Entity[], boss: Entity) => void;
...
export const useWorldStore = create<World>((set) => ({
    ...
    setMap: (ID: string, BG: string, items: (Weapon | Armor)[], commonEntity: Entity[], hardEntity: Entity[], boss: Entity) =>
        set((state) => ({
            data: {
                ...state.data, mapID: ID,
                mapBackground: BG,
